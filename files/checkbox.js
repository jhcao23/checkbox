...
function getTrimmedLowerCase(aString){
	return $j.trim(aString).toLowerCase();
}
...
function check8(checkboxInput){
	if(checkboxInput){
		$j(checkboxInput).attr('checked', true);
	}
}
function check8All(checkboxInputAll){
	if(checkboxInputAll){
		$j(checkboxInputAll).each(function(){
...
function uncheck8(checkboxInput){
	if(checkboxInput){
		$j(checkboxInput).attr('checked', false);
	}
}
function uncheck8All(checkboxInputAll){
	if(checkboxInputAll){
		$j(checkboxInputAll).each(function(){
